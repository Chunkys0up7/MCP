...
async def test_llm_prompt_execution(mock_aiohttp_session, mock_response):
    ...
    # Setup
    mock_aiohttp_session.return_value.__aenter__.return_value.post.return_value = mock_response
    client = MCPClient()
...
async def test_timeout_handling(mock_aiohttp_session):
    ...
    # Setup
    mock_aiohttp_session.return_value.__aenter__.return_value.post.side_effect = aiohttp.ClientTimeout()
...
async def test_connection_error_handling(mock_aiohttp_session):
    ...
    # Setup
    mock_aiohttp_session.return_value.__aenter__.return_value.post.side_effect = aiohttp.ClientError()
