...
def upgrade() -> None:
    ...
    #            existing_nullable=False)
    op.add_column(
        "chain_sessions", sa.Column("updated_at", sa.DateTime(), nullable=False)
    )
    ...
    op.add_column(
        "mcp_configurations", sa.Column("updated_at", sa.DateTime(), nullable=False)
    )
    ...
    op.add_column(
        "mcp_permissions", sa.Column("created_at", sa.DateTime(), nullable=False)
    )
    op.add_column(
        "mcp_permissions", sa.Column("updated_at", sa.DateTime(), nullable=False)
    )
    ...
    op.add_column(
        "workflow_definitions", sa.Column("input_schema", sa.JSON(), nullable=False)
    )
    op.add_column(
        "workflow_definitions", sa.Column("output_schema", sa.JSON(), nullable=False)
    )
    ...
    op.add_column(
        ...
        sa.Column("error_strategy", error_strategy_enum, nullable=False),
    )
    ...
    op.add_column(
        "workflow_runs", sa.Column("created_at", sa.DateTime(), nullable=False)
    )
    op.add_column(
        "workflow_runs", sa.Column("updated_at", sa.DateTime(), nullable=False)
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "workflow_runs", sa.Column("step_results", sqlite.JSON(), nullable=True)
    )
    op.add_column("workflow_runs", sa.Column("run_id", sa.NUMERIC(), nullable=False))
    op.drop_constraint(None, "workflow_runs", type_="foreignkey")
    op.create_foreign_key(
        None, "workflow_runs", "workflow_definitions", ["workflow_id"], ["workflow_id"]
    )
    op.create_index(
    ...
    op.alter_column(
        "workflow_runs", "inputs", existing_type=sqlite.JSON(), nullable=True
    )
    op.alter_column(
        "workflow_runs",
        "status",
        existing_type=sa.Enum(
            "pending", "running", "completed", "failed", name="workflow_status"
        ),
    ...
    op.add_column(
        "workflow_definitions", sa.Column("workflow_id", sa.NUMERIC(), nullable=False)
    )
    ...
    op.drop_constraint(None, "mcp_versions", type_="foreignkey")
    op.create_foreign_key(
        None, "mcp_versions", "mcps", ["mcp_id"], ["id"], ondelete="CASCADE"
    )
    op.create_index(
        op.f("idx_mcp_version"), "mcp_versions", ["mcp_id", "version"], unique=1
    )
    op.alter_column(
        "mcp_versions",
        "created_at",
